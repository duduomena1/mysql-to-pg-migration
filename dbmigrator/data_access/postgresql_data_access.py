...
class PostgreSQLWriter:
    def __init__(self, postgresql, table, schema="", buffer_size=100, bulk_commit=True):
        ...
        print (f"QUERY INSERT -> INSERT INTO {self.schema}{self.table.name} ({self.column_names})")
    ...
    def flush_buffer(self):
        ...
        try:
            ...
            self.close_cursor()
            self.buffer.clear()  # Clear buffer to avoid retrying bad data
            # Rollback to clean transaction state
            try:
